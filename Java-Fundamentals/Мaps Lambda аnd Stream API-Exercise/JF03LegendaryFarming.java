...
public class JF03LegendaryFarming {
    public static void main(String[] args) {
        ...
        items.put("motes",0);
        Map<String, Integer> junItems = new LinkedHashMap<>();
        boolean isWin = false;
        while (!isWin) {
            ...
            for (int index = 0; index <=inputData.length - 1; index += 2) {
                ...
                if (material.equals("shards") || material.equals("fragments") || material.equals("motes")) {
                    ...
                    if (!junItems.containsKey(material)) {
                        junItems.put(material, quantity);
                    } else {
                        int current = junItems.get(material);
                        junItems.put(material, current + quantity);
        ...
        junItems.entrySet().forEach(entry -> System.out.println(entry.getKey() + ": " + entry.getValue()));
    }
}
